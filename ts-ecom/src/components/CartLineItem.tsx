...
//             <label className="offscreen" htmlFor="itemQty">Item Quantity</label>
//             <select name="itemQty" id="itemQty" className="cart__select" value={item.qty} aria-label="Item-Quantity"
