...
//these are the types of each cartItems to be used 
...
//this shows the state of  that holds all cart itemms
type CartStateType = {cart: CartItemType[]}
//this shows the initial state of the cart
const initCartState: CartStateType = {cart:[]}
//contains all possibleactions that could happen to the cart
...
//this shows the acctions that will be passed to the reducer
...
CartStateType => {
    switch(action.type){
        ...
        case REDUCER_ACTION_TYPE.QUANTITY:{
            if(!action.payload){
                throw new Error("action.payload missing in QUANTITY section")
            }
            ...
            if(!itemExists){
                throw new Error("Items must exist in order to update")
            }
